...
export default function Sidebar() {
    ...
    const [isTablet, setIstablet] = useState(window.innerWidth <= 800);
    ...
    return (
        <div className="w-64 max-[800px]:w-[130px] max-[800px]:justify-center">
                ...
                <div className="flex items-center">
                    {isTablet ? (
                        <svg width="58" height="57" viewBox="0 0 58 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.760986" y="0.260864" width="56.4782" height="56.4782" rx="28.2391" fill="url(#paint0_linear_5_5548)" />
                        ...
                        <svg width="144" height="57" viewBox="0 0 144 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect y="0.260864" width="56.4782" height="56.4782" rx="28.2391" fill="url(#paint0_linear_5_4777)" />
            ...
            <menu className="w-full h-full px-6 max-[800px]:px-2 max-[800px]:w-[50px]  max-[800px]:w-[130px] max-[800px]:items-center max-[800px]:justify-center">
                    ...
                    if (button.text === "Products") {
                        return (
                            <div key={index} className={productsOpen ? "rounded-lg p-1" : ""}>
                                <button 
                                    className={`w-full max-[800px]:justify-center ${productsOpen ? "bg-[#4F56D3] text-white" : ""} flex items-center gap-2 h-[50px] rounded-md`} 
